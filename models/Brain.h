...
class Brain : public BrainWrapper
{
  public:
  ...
  public:
    ...
    Brain(Brain *brain, int diffBrainSize, int debug = 0, std::string name = "0", double mu_newConnection=0.0, double mu_modConnection=0.0, double mu_newNeuron=0.0);
    ~Brain();
