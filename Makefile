...
Ecosystem: lib/Entity.o lib/Neuron.o  lib/Brain.o lib/NeuralNetwork.o lib/BrainNN.o lib/Creature.o  lib/Plank.o lib/Ecosystem.o
	c++ lib/Entity.o lib/Neuron.o  lib/Brain.o lib/NeuralNetwork.o lib/BrainNN.o lib/Creature.o lib/Plank.o lib/Ecosystem.o -o Ecosystem $(ROOTFLAGS) $(ROOTLIBS) -O3
...
# lib/BrainWrapper.o: models/BrainWrapper.h src/BrainWrapper.cc
# 	c++ -c src/BrainWrapper.cc -o lib/BrainWrapper.o -c $(ROOTFLAGS) -O3
...
lib/BrainNN.o: models/BrainNN.h src/BrainNN.cc
	c++ -c src/BrainNN.cc -o lib/BrainNN.o -c $(ROOTFLAGS) -O3
